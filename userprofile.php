...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="userhome.php"><svg class="glyph stroked home"><use xlink:href="#stroked-home"/></svg> HOME</a></li>
	...
	<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userprofile.php#details_heading"><div id="details_heading" class="panel-heading"  onclick="show_block('details_form');"><strong>Your Details. You may edit where applicable.</strong></div></a>
                	...
                	?>
						<div class="col-md-6">
							<form role="form" method="post" action="updateuser.php">
								...
								<div class="form-group">
									<label>Application Serial Number: <?php echo $serial_no; ?></label>
								</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userprofile.php#password_heading"><div id="password_heading" class="panel-heading" id="details" onclick="show_block('password_form');"><strong>CHANGE PASSWORD</strong></div></a>
					<div class="panel-body" id="password_form" style="display: none;">
						<div class="col-md-6">
							<form role="form" method="post" action="userpassword.php">

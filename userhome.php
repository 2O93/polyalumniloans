...
?>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="#"><svg class="glyph stroked home"><use xlink:href="#stroked-home"/></svg> HOME</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" id="pagetop"><strong><?php echo $user_id ?>'s Home. Below are your application details</strong></h1>
				...
				<div class="panel-heading">Jump to section: 
					<a href="userhome.php#residential" onclick="show_block('residential_info');"><svg class="glyph stroked home"><use xlink:href="#stroked-home"/></svg>Residential...</a>
					<a href="userhome.php#educational" onclick="show_block('educational_info');"><svg class="glyph stroked app window with content"><use xlink:href="#stroked-app-window-with-content"/></svg>Educational...</a>
					<a href="userhome.php#admission" onclick="show_block('admission_info');"><svg class="glyph stroked pen tip"><use xlink:href="#stroked-pen-tip"/></svg>Admission...</a>
					<a href="userhome.php#loanamounts" onclick="show_block('loanamounts_info');"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg>Loan Amounts...</a>
					<a href="userhome.php#fathers" onclick="show_block('fathers_info');"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>Fathers...</a>
					<a href="userhome.php#mothers" onclick="show_block('mothers_form');"><svg class="glyph stroked female user"><use xlink:href="#stroked-female-user"/></svg>Mothers...</a>
				</div>
				<div class="panel-heading">Jump to section: 
					<a href="userhome.php#sponsors" onclick="show_block('sponsors_info');"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg>Sponsors...</a>
					<a href="userhome.php#siblings" onclick="show_block('siblings_info');"><svg class="glyph stroked female user"><use xlink:href="#stroked-female-user"/></svg>Siblings...</a>
					<a href="userhome.php#social" onclick="show_block('social_info');"><svg class="glyph stroked two messages"><use xlink:href="#stroked-two-messages"/></svg>Social...</a>
					<a href="userhome.php#dependants" onclick="show_block('dependants_info');"><svg class="glyph stroked paperclip"><use xlink:href="#stroked-paperclip"/></svg>Dependants...</a>
					<a href="userhome.php#guarantor" onclick="show_block('guarantor_info');"><svg class="glyph stroked brush"><use xlink:href="#stroked-brush"/></svg>Guarantors...</a>
				</div>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#personal_heading"><div id="personal_heading" class="panel-heading" id="personal" onclick="show_block('personal_info');"><strong>Your Personal Details</strong></div></a>
		...
		<div class="row" id="residential">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#residential_heading"><div id="residential_heading" class="panel-heading" onclick="show_block('residential_info');"><strong>Your Residential Contact Details (Current Address)</strong></div></a>
		...
		<div class="row" id="educational">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#educational_heading"><div id="educational_heading" class="panel-heading" onclick="show_block('educational_info');"><strong>Your Educational Background Information</strong></div></a>
		...
		<div class="row" id="admission">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#admission_heading"><div id="admission_heading" class="panel-heading" onclick="show_block('admission_info');"><strong>Your Admission Details</strong></div></a>
		...
		<div class="row" id="loanamounts">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#loanamounts_heading"><div id="loanamounts_heading" class="panel-heading" onclick="show_block('loanamounts_info');"><strong>Loan Amount required for one academic year</strong></div></a>
		...
		<div class="row" id="fathers">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#fathers_heading"><div id="fathers_heading" class="panel-heading" onclick="show_block('fathers_info');"><strong>Your Father</strong></div></a>
		...
		<div class="row" id="mothers">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#mothers_heading"><div id="mothers_heading" class="panel-heading" onclick="show_block('mothers_info');"><strong>Your Mother</strong></div></a>
		...
		<div class="row" id="sponsors">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#sponsors_heading"><div id="sponsors_heading" class="panel-heading" onclick="show_block('sponsors_info');"><strong>Your Sponsors</strong></div></a>
		...
		<div class="row" id="siblings">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#siblings_heading"><div id="siblings_heading" class="panel-heading" onclick="show_block('siblings_info');"><strong>Your siblings</strong></div></a>
...
EOF;
		...
		<div class="row" id="social">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#social_heading"><div id="social_heading" class="panel-heading" onclick="show_block('social_info');"><strong>Family Social Economic Indicators</strong></div></a>
		...
		<div class="row" id="dependants">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#dependants_heading"><div id="dependants_heading" class="panel-heading" onclick="show_block('dependants_info');"><strong>Family Dependants</strong></div></a>
...
EOF;
		...
		<div class="row" id="guarantor">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="userhome.php#guarantor_heading"><div id="guarantor_heading" class="panel-heading" onclick="show_block('guarantor_info');"><strong>your Guarantor</strong></div></a>
	...
	<footer class="container-fluid text-center">
  		<a href="userhome.php#pagetop" title="To Top">

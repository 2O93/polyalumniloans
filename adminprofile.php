...
?>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="adminprofile.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"/></svg> Profile Settings</a></li>
		</ul>
	...
	<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="adminprofile.php#details_heading"><div id="details_heading" class="panel-heading" id="details" onclick="show_block('details_form');"><strong>Your Details. You may edit where applicable.</strong></div></a>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="adminprofile.php#password_heading"><div id="password_heading" class="panel-heading" id="details" onclick="show_block('password_form');"><strong>CHANGE PASSWORD</strong></div></a>
					<div class="panel-body" id="password_form" style="display: none;">
						<div class="col-md-6">
							<form role="form" method="post" action="adminpassword.php">

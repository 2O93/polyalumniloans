<?php 
    ...
    if ($logger_pos != "board_member") {
    	echo "<script>alert('Login as a Board Member to access this page')</script>";
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu override-a" role="menu">
							<li><a href="adminprofile.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Profile</a></li>

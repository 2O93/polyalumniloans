...
?>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="#"><svg class="glyph stroked hourglass"><use xlink:href="#stroked-hourglass"/></svg> Edit Mode</a></li>
	...
	<?php 
		...
		$dependantsq = "SELECT * FROM apps_dependants WHERE serial_no = '$serial_no'";

		$educationq = "SELECT * FROM apps_education WHERE serial_no = '$serial_no'";
		$fatherq = "SELECT * FROM apps_father WHERE serial_no = '$serial_no'";
		...
		$motherq = "SELECT * FROM apps_mother WHERE serial_no = '$serial_no'";
		...
		$residentialq = "SELECT * FROM apps_residential WHERE serial_no = '$serial_no'";
		$siblingsq = "SELECT * FROM apps_siblings WHERE serial_no = '$serial_no'";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" id="pagetop">Edit Application: <?php echo $serial_no." ".$firstnameper." ".$surnameper; ?></h1>
				<h3>Please edit one section at a time</h3>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<a href="datahome.php#personal_heading"><div id="personal_heading" class="panel-heading" id="personal" onclick="show_block('personal_form');"><strong>Personal Details of the Applicant</strong></div></a>
					<div class="panel-body" id="personal_form" style="display: none;">
						<div class="col-md-6">
							<form role="form" method="post" action="edit_personal.php">
							
								<div class="form-group">
									<label>Serial Number: <?php echo $serial_noper ?></label>
									<select class="form-control" name="serial_no" style="display: none;">
										<option value="<?php echo $serial_noper ?>" selected>Hidden by default</option>
									</select>
								</div>

								<div class="form-group">
									<label>First Name</label>
									<input class="form-control" name="firstname" value="<?php echo $firstnameper ?>">
								</div>
																
								<div class="form-group">
									<label>Surname</label>
									<input class="form-control" name="surname" value="<?php echo $surnameper ?>">
								</div>
								
								<div class="form-group">
									<label>Other Names</label>
									<input class="form-control" name="other_names" value="<?php echo $other_namesper ?>">
								</div>
																
								<div class="form-group">
									<label style="color: red;">Gender: NB: please make sure you check the correct gender when editing</label>
									<div class="radio">
										<label>
								...
								<div class="form-group">
									<label>Address</label>
									<input class="form-control" name="address" value="<?php echo $addressper ?>">
								</div>
								
								<div class="form-group">
									<label>Phone</label>
									<input class="form-control" name="phone" value="<?php echo $phoneper ?>">
								</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>Mobile</label>
									<input class="form-control" name="mobile" value="<?php echo $mobileper ?>">
								</div>
								
								<div class="form-group">
									<label>E-mail</label>
									<input class="form-control" type="email" name="email" value="<?php echo $emailper ?>">
								</div>
								
								<div class="form-group">
									<label>District</label>
									<select class="form-control" name="district">
										<option value="<?php echo $districtper ?>" selected><?php echo $nameper ?></option>
								...
								<div class="form-group">
									...
									<input class="form-control" name="township" value="<?php echo $townshipper ?>">
								</div>

								<div class="form-group">
									<label>Village</label>
									<input class="form-control" name="village" value="<?php echo $villageper ?>">
								</div>

								<div class="form-group">
									<label>Date of Birth</label>
									<input class="form-control" name="dob" value="<?php echo $dobper ?>">
								</div>

								<div class="form-group">
									<label>Edit Data for this section only before proceeding</label>
								</div>
						...
						<div class="col-md-6">
							<form role="form">
								...
								<div class="form-group">
									...
									<input class="form-control" name="admission_year" value="<?php echo $admission_yearr ?>">
								</div>
																
								<div class="form-group">
									<label>Registration Number</label>
									<input class="form-control" name="reg_number" value="<?php echo $reg_numberr ?>">
								</div>
								
								<div class="form-group">
									<label>Current Year of Study</label>
									<input class="form-control" name="year_of_study" value="<?php echo $year_of_studyr ?>">
								</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<option value="<?php echo $programrn ?>" selected><?php echo $programr ?></option>
										<?php 
...
EOF;
								...
								<div class="form-group">
									...
									<option value="<?php echo $facultyrn ?>" selected><?php echo $facultyr ?></option>
										<?php 
...
EOF;
	...
	<footer class="container-fluid text-center">
  		<a href="dataedit.php#pagetop" title="To Top">
